...
function clearAllData(e) {
  ...
  // userList를 [] 만들기
  if (confirm("절말로 모든 사용자를 삭제하시겠습니다까?")) {
    // localStorage.removeItem("userList"); 로컬스토리지 내에서 특정 키만 삭제
    // localStorage.clear(); = 내부에 존재하는 모든 데이터 삭제
    localStorage.clear();
